...
export const WelcomeNav = () => {
  ...
  return (
    <>
      <div className="px-4 py-2 lg:px-8 md:py-4 rounded-full bg-[#f2f2f2] flex items-center justify-between">
        ...
        <div className="items-center justify-center gap-4 lg:w-1/3 hidden lg:flex">
          {linksData.map((link) => {
            return (
              <Link key={link.id} href={link.href} className="no-underline hover:underline hover:text-[#00abc2] text-lg text-black">
                {link.text}
              </Link>
            )
          })}
