...
export default function OpenCard({product, price, logPrice, weight, date, type, from, to, distance, description, status, phone, role, onClick}) {
    return (
